...
const Product = class Product {
    ...
    static printProducts = (products) => {
       products.forEach(prod => {
            ...
            const availability = prod.availability === 'In Stock' ? 'Yes' : 'No';
            // console.log("Product: " + prod.name + ", Cost: $" + prod.price + ", Available: " + prod.availability==="In Stock" ? "Yes" : "No");
            console.log(`Product: ${prod.name}, Cost: $${prod.price.toFixed(2)}, Availability: ${availability}`);
        });
    }
